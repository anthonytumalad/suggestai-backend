<template>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        <div class="max-w-md w-full bg-white rounded-lg shadow-xl p-8 text-center">
            ...
            <div v-if="$page.props.errors?.error" class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                <p class="text-sm text-red-600">{{ $page.props.errors.error }}</p>
            </div>
            ...
            <p class="mt-6 text-xs text-gray-500">
                Only @thelewiscollege.edu.ph accounts are allowed
            </p>
        </div>
    </div>
</template>
